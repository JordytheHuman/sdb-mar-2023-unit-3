...
Variables
[x] Create a lightCurrent variable and set it equal to redLight.
...
[x] Create a console log that informs the user of the state of the traffic light.
...
let lightStates = {
    red: ["green", "blinking red", "blinking yellow"],
    "blinking red": ["red"],
    "blinking yellow": ["red", "green"],
