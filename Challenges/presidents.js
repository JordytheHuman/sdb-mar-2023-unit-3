...
console.log(alivePresidents.length);

//? Creat a list of all the presidents that are dead
...
// ? Create a loop that goes through the past presidents and figure out the age of which they died.

for (president of deadPresidents) {
// passed - year = age
    let age = president.passed - president.year;
    console.log(`President ${president.first} ${president.last} was ${age} when they passed away in the year of ${president.passed}.`);
}

// ? See if you can find the president that has the oldest age of living.