...
- Example of Datatypes: string, boolean, number, objects, arrays, functions, undefined, and null

- What makes arrays really powerful is that they are loopable
...
console.log("looking for spider,", mixedDataArr[0])

//? How Do I Access The 55?
console.log("looking for the 55,", mixedDataArr[3][1])

// ? How do I know the size of the array [23, 55, 10]
console.log("mixedDataArr Size: ", mixedDataArr[3].length);
...
//needs to be = to an open array so that we can push into the array!^^
...
for(groceryItemPrice of groceryItemPrices){
    ...
    groceryitemPricesWithTax2.push(+itemPriceWithTax.toFixed(2));
